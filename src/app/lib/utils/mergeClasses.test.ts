...
describe("mergeClasses", () => {
  ...
  it("should include classes from an object where the value is true", () => {
    expect(mergeClasses({ class1: true, class2: false, class3: true })).toBe(
      "class1 class3"
    );
  });
  ...
  it("should handle a mix of strings and objects", () => {
    expect(
      mergeClasses("class1", { class2: true, class3: false }, "class4")
    ).toBe("class1 class2 class4");
  });

  it("should ignore undefined values", () => {
    expect(mergeClasses("class1", undefined, { class2: true })).toBe(
      "class1 class2"
    );
  });
